...
/* translucent treatment for native panes the client marks at runtime
   ...
   see-through look of the 对话 pane */
...
/* nodes — restrained surfaces, precise type, status via tint+dot */
.tg-node .tg-nodebox{fill:var(--tg-surface);stroke:var(--tg-hairline-2);stroke-width:1;transition:stroke .15s}
.tg-node:hover .tg-nodebox{stroke:color-mix(in srgb, var(--dsw-alias-border-l4,#b0bed8) 58%, transparent)}
      ...
      _drawNode(n, p, vis, flags) {
        ...
        if (n.status === 'RUNNING') {
          g.appendChild(svgEl('rect', {
            class: 'tg-pulse', x: 0, y: 0, width: p.w, height: p.h, rx: 8,
            fill: 'none', stroke: statusStroke, 'stroke-width': 1.4,
          }));
        }
        g.appendChild(svgEl('rect', {
          class: 'tg-nodebox', x: 0, y: 0, width: p.w, height: p.h, rx: 8,
        }));
        ...
        g.appendChild(svgEl('circle', { cx: 12, cy: p.h / 2, r: 3.5, fill: dotColor }));
